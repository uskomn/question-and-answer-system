  ...
  <div class="app-container">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <!-- Status Indicator -->
        <div class="status-indicator" :class="{ ready: chatStore.isModelReady }">
          <span class="status-dot"></span>
          <span class="status-text">{{ chatStore.isModelReady ? 'Ready' : 'Loading...' }}</span>
        </div>
        
        <!-- Model Info -->
        <div class="model-badge" v-if="chatStore.modelInfo">
          <span class="model-name">{{ chatStore.modelInfo.model_name }}</span>
          <span class="model-device">{{ chatStore.modelInfo.device }}</span>
        </div>
      </div>
    </header>

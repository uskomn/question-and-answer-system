...
class KnowledgeBase:
    def __init__(self, kb_dir: str = "./kb_data_en"):
        ...
        with open(self.kb_dir / "model_info.json", encoding="utf-8") as f:
            info = json.load(f)
        # 本地
        self.model_name: str = "E:\PycharmProjects\question and answer system\RAG\models/bge-base-en-v1.5"
        #服务器
        # self.model_name: str = "/home/ubuntu/question-and-answer-system/RAG/models/bge-small-zh-v1.5"
